...
var mode=1;
let proj="champions_world"
let projP="champions.world.autojs"
let projR="champions.world"
function getPath(p){
    switch(mode){
        case 5:
...
function logic1() { 
    ...
    sleep(500)
    tests[3].existApply(closeSpin)
}
function closeSpin(x,y,w,h){
    click(x,y)
    sleep(1000)
    click(1547,114)
}
function closeGlove(x,y,w,h){
    click(x,y)
    sleep(1000)
    click(1542,313)

}
function closeDaily(x,y,w,h){
    click(x,y)
    sleep(1000)
    click(1265,388)
