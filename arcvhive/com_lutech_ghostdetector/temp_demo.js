...
var mode=1;
let proj="com_lutech_ghostdetector"
let projP="com.lutech.ghostdetector.autojs"
let projR="com.lutech.ghostdetector"
function getPath(p){
    switch(mode){
        case 5:
...
function guid(){
    ...
    if(zutils.afollow([
        ["t","English",0,0],
        ["i","com.lutech.ghostdetector:id/btnTickLanguage",0,1000], 
    ])){
        zutils.afollow([
            ["t","Next",0,0],
            ["i","com.lutech.ghostdetector:id/btnNext",0,1000],
            ["i","com.lutech.ghostdetector:id/btnAccept",0,1000],
            ["i","com.lutech.ghostdetector:id/btnApply",0,1000],
        ])
        sleep(1000)
        ...
        zutils.afollow([ 
            ["i","com.lutech.ghostdetector:id/btnTurnOnOff",0,1000],
            ["i","com.lutech.ghostdetector:id/btnStart",0,1000],
            ["i","com.lutech.ghostdetector:id/btnNext",0,1000],
            ["i","com.lutech.ghostdetector:id/swLocation",0,1000],
            ["i","com.android.permissioncontroller:id/permission_allow_foreground_only_button",0,1000],
            ["i","com.lutech.ghostdetector:id/btnContinue",0,1000],
            ["i","com.lutech.ghostdetector:id/btnBack",0,1000],
        ])
    }
    ...
    zutils.afollow([ 
        ["i","com.lutech.ghostdetector:id/btnGhostDetail",0,1000], 
        ["i","com.lutech.ghostdetector:id/ivBack",0,2000],  
    ])
    zutils.afollow([  
        ["i","com.lutech.ghostdetector:id/btnBack",0,2000],  
    ])
    zutils.afollow([ 
        ["i","com.lutech.ghostdetector:id/btnMaybeLater",0,1000], 
    ])
    zutils.afollow([ 
        ["i","com.lutech.ghostdetector:id/button_on_off",0,1000], 
        ["i","com.lutech.ghostdetector:id/ivWatchAds",0,1000], 
    ])
}
function shift(){ 
    // swipe(TAP.x,TAP.y,TAP.x,TAP.y-400,200) 
...
function singleLoop(){
    if(zutils.afollow([
        ...
        while(!zutils.afollow([ 
            ...
            if(!zutils.afollow([ 
                ["t","Scan Camera Around",0,1000,no_action], 
            ])){
                zutils.afollow([    
                    ["i","com.lutech.ghostdetector:id/button_on_off",0,1000], 
                ])  
        ...
        while(!zutils.afollow([ 
            ...
            zutils.afollow([ 
                ["i","com.lutech.ghostdetector:id/ivBack",0,1000], 
            ])
        } 
...
//     // // warmup play
    app.launch(projR)
   // app.startActivity({ 
   //     packageName: "com.lutech.ghostdetector",
