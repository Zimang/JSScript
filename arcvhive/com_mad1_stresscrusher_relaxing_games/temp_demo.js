...
var mode=1;
let proj="com_mad1_stresscrusher_relaxing_games"
let projP="com.mad1.stresscrusher.relaxing.games.autojs"
let projR="com.mad1.stresscrusher.relaxing.games"
function getPath(p){
    switch(mode){
        case 5:
...
function main(){
    ...
    app.launch(projR)
   // app.startActivity({ 
   //     packageName: "com.mad1.stresscrusher.relaxing.games",
