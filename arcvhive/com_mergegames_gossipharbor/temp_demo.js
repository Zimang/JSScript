...
var mode=1;
let proj="com_mergegames_gossipharbor"
let projP="com.mergegames.gossipharbor.autojs"
let projR="com.mergegames.gossipharbor"
function getPath(p){
    switch(mode){
        case 5:
...
function preface(x,y,w,h){
    gesture(1000,[265,979],[265,1122])
    sleep(500)
    gesture(1000,[265,1122],[400,1122])
    sleep(500)
    gesture(1000,[400,1122],[520,1122])
    sleep(500)
    click(520,1122)
    sleep(500)
    click(520,1122)
...
function main(){
    ...
    // app.launch(projR)
   // // app.startActivity({ 
  //  //     packageName: "com.mergegames.gossipharbor",
