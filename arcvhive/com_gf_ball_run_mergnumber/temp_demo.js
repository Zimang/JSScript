...
var mode=1;
let proj="com_gf_ball_run_mergnumber"
let projP="com.gf.ball.run.mergnumber.autojs"
let projR="com.gf.ball.run.mergnumber"
function getPath(p){
    switch(mode){
        case 5:
...
function guid(){
    ...
    if(tests[1].existApply(no_action)){
        ...
        if(tests[1].existApply(no_action)){
            ...
            if(tests[1].existApply(no_action)){
                gesture(1000,
                    [getRandomInt(220,400),1200],
                    [getRandomInt(670,780),1200],
                )
            }
...
function main(){
    ...
    // app.launch(projR)
   // app.startActivity({ 
   //     packageName: "com.gf.ball.run.mergnumber",
