...
var mode=1;
let proj="wsj_reader_sp"
let projP="wsj.reader_sp.autojs"
let projR="wsj.reader_sp"
function getPath(p){
    switch(mode){
        case 5:
...
function logic1() { 
    zutils.afollow([
        ["t","MyWSJ",0],  
        ["t","Print Edition",0,2500],  
        ["t","Crosswords",0,2500],  
        ["t","Market Data",0,2500],  
        ["t","Home",1000,1000]
    ]) 
...
function logic2() { 
    zutils.afollow([
        ...
        ["t","Markets",0,1500], 
        ["t","Technology",0,1500],  
        ["t","Business",1000,1000]
    ])
}

function logic3() { 
    zutils.afollow([
        ["d","Open Profile Drawer",0],  
        ()=>{
            sleep(500)
            click(TAP.x*1.4,TAP.y)
            sleep(500)
            return true
        }, 
    ])
