...
var mode=1;
let proj="com_qrcodescanner_barcodereader_qrgenerator"
let projP="com.qrcodescanner.barcodereader.qrgenerator.autojs"
let projR="com.qrcodescanner.barcodereader.qrgenerator"
function getPath(p){
    switch(mode){
        case 5:
...
function right100(x,y,w,h){
    click(x-w/2-100,y)
}
function bt100(x,y,w,h){
    click(x,y+100)
}
...
function guid(){
    grant()
    zutils.afollow([
        ["t","Select Language",0,0,bt100],
        ["t","Next",0,1000],
        ["t","Scan QR Code",0,1000],
        ["t","Next",0,1000],
        ()=>{ 
            right2Left()
            right2Left()
        ...
        ["t","Start",0,1000],
        ["t","Camera",0,1000,right100],
        ["t","WHILE USING THE APP",0,1000],
        ["t","Notification",0,1000,right100],
        ["t","ALLOW",0,1000],
        ["t","Daily Awesome",0,1000,right100],
        ["t","Remind me later",0,1000],
        ()=>{ 
            TAP.clp(1,0.3)
            return true
        },
    ...
    zutils.afollow([
        ["t","Scan QR Code",0],
        ["t","ALLOW",0,1000],
        ["i","com.qrcodescanner.barcodereader.qrgenerator:id/ivBack",1000,1000], 
    ])
    zutils.afollow([ 
        ["i","com.qrcodescanner.barcodereader.qrgenerator:id/ivBack",0,1000], 
    ])
}
function shift(){ 
    // swipe(TAP.x,TAP.y,TAP.x,TAP.y-400,200) 
...
function logic1() { 
    ...
    zutils.afollow([
        ["t","Settings",0], 
        ["i","com.qrcodescanner.barcodereader.qrgenerator:id/switch01",1000,1000], 
        ["i","com.qrcodescanner.barcodereader.qrgenerator:id/switch1",1000,1000], 
        ["i","com.qrcodescanner.barcodereader.qrgenerator:id/switchOpenWebsiteAutomatically",1000,1000], 
        ["i","com.qrcodescanner.barcodereader.qrgenerator:id/switchCopyToClipboard",1000,1000], 
        ["t","Home",1000,1000], 
    ])
}
...
function logic2() { 
    ...
    zutils.afollow([ 
        ["i","com.qrcodescanner.barcodereader.qrgenerator:id/tvCreateDocument",0], 
        ["d","Close",1000,10000],  
    ])
}
...
function logic3() { 
    zutils.afollow([
        ["t","Settings",0], 
        ["t","Languages",1000,1000], 
        ["d","Back",1000,1000], 
        ["i","com.qrcodescanner.barcodereader.qrgenerator:id/llHelp",1000,1000], 
        ["i","com.qrcodescanner.barcodereader.qrgenerator:id/ivBack",1000,1000], 
        ["t","Home",1000,1000], 
    ])
...
function singleTest(){  
//"com.qrcodescanner.barcodereader.qrgenerator:id/history
// "
    // guid()
    // logic1()
    logic2()
