...
var mode=1;
let proj="com_MegaJoy_DogRush"
let projP="com.MegaJoy.DogRush.autojs"
let projR="com.MegaJoy.DogRush"
function getPath(p){
    switch(mode){
        case 5:
...
function ddOneLevel(centerX,centerY,w,h){
    click(TAP.x*0.3,TAP.y*0.4)
    sleep(100) 
}
 
function ddDown2Up(centerX,centerY,w,h){
    gesture(2000,[centerX,centerY+TAP.y*0.8],[centerX,centerY])
    sleep(100) 
}
 
function ddExit(centerX,centerY,w,h){
    click(TAP.x*0.15,TAP.y*0.12)
    sleep(100) 
}
...
function singleLoop(){
    zutils.afollow([
        ["c",tests[6],0,0,ddDown2Up],
        ["c",tests[7],0,1000,ddDown2Up], 
    ])
  
    tests[5].existApply(ddclickCenter) 
    zutils.afollow([
        ["c",tests[1],0,0,ddExit], 
    ]) 
    tests[3].existApply(ddOneLevel) 
}
...
function singleTest(){
    ...
    //     ["c",tests[7],0,1000,ddDown2Up], 
    // ]) ){
    //     tests[5].waitMe(ddclickCenter,200,1000)
    // }
    zutils.afollow([
        ["c",tests[6],0,0,ddDown2Up],
        ["c",tests[7],0,1000,ddDown2Up], 
