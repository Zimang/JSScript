...
var mode=1;
let proj="pranksounds_airhornhaircutclipper_funnyjoke_hiprank"
let projP="pranksounds.airhornhaircutclipper.funnyjoke.hiprank.autojs"
let projR="pranksounds.airhornhaircutclipper.funnyjoke.hiprank"
function getPath(p){
    switch(mode){
        case 5:
...
function guid(){
    ...
    // ])
    zutils.afollow([
    ["t","Rate us the best",0,0,breakUP], 
    ])
    zutils.afollow([
    ["i","close-button",0,0], 
    ])
    zutils.afollow([
    ["i","pranksounds.airhornhaircutclipper.funnyjoke.hiprank:id/tv_done",0,0], 
    ])
    zutils.afollow([
    ["i","pranksounds.airhornhaircutclipper.funnyjoke.hiprank:id/tv_skip",0,1000],
    ]) 
    zutils.afollow([
    ["t","Let's Prank Now",0,1000],
    ]) 
}
function breakUP(x,y,w,h){
    back()
}
function shift(){ 
    // swipe(TAP.x,TAP.y,TAP.x,TAP.y-400,200) 
...
function logic2() { 
    ...
    zutils.afollow([
        ["t","Fart Noises",0,1000], 
        ])
    zutils.afollow([
    ["i","pranksounds.airhornhaircutclipper.funnyjoke.hiprank:id/tv_play",0,1000], 
    ])
    zutils.afollow([
    ["i","pranksounds.airhornhaircutclipper.funnyjoke.hiprank:id/iv_back",0,1000],
    ["i","pranksounds.airhornhaircutclipper.funnyjoke.hiprank:id/iv_back",0,1000],
    ])
}
...
//     app.launch(projR)
//    // app.startActivity({ 
//    //     packageName: "pranksounds.airhornhaircutclipper.funnyjoke.hiprank",
