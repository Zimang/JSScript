...
var mode=1;
let proj="com_blendergame_smash"
let projP="com.blendergame.smash.autojs"
let projR="com.blendergame.smash"
function getPath(p){
    switch(mode){
        case 5:
...
function fuzzClick(x,y,fuzz){
    click(x+getRandomInt(0,fuzz),y+getRandomInt(0,fuzz))
}

function fuzzPress(x,y,t,fuzz){
    press(x+getRandomInt(0,fuzz),y+getRandomInt(0,fuzz),t+getRandomInt(0,fuzz))
}
...
function main(){
    ...
    app.launch(projR)
   // app.startActivity({ 
   //     packageName: "com.blendergame.smash",
