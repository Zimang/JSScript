...
var mode=1;
let proj="com_santa_fake_prank_video_call"
let projP="com.santa.fake.prank.video.call.autojs"
let projR="com.santa.fake.prank.video.call"
function getPath(p){
    switch(mode){
        case 5:
...
function main(){
    ...
    app.launch(projR)
   // app.startActivity({ 
   //     packageName: "com.santa.fake.prank.video.call",
