...
var mode=1;
let proj="com_car_climb_draw_bridge"
let projP="com.car.climb.draw.bridge.autojs"
let projR="com.car.climb.draw.bridge"
function getPath(p){
    switch(mode){
        case 5:
...
function centerScreenClick(x,y,w,h){
    click(TAP.x,TAP.y)
    sleep(1000)
}
...
let again=new zutils.CachedBT(
    "cut_2_3.png",getPath(""),"buttom 1"
)   

let tap2=new zutils.CachedBT(
...
let shop1=new zutils.CachedBT(
    "cut_1_4.png",getPath(""),"buttom 1"
) 
let noThanks=new zutils.CachedBT(
    "cut_5_1.png",getPath(""),"buttom 1"
)    

let looseIt=new zutils.CachedBT(
...
function singleLoop(){
    ...
    shop.existApply(centerScreenClick) 
    while(again.existApply(no_action)) {
        fly()
    } 
    tap2.existApply(ddclickCenter)
    noThanks.existApply(ddclickCenter)
    looseIt.existApply(ddclickCenter)
