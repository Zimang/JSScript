...
var mode=1;
let proj="com_multicast_piece_of_art"
let projP="com.multicast.piece_of_art.autojs"
let projR="com.multicast.piece_of_art"
function getPath(p){
    switch(mode){
        case 5:
...
function singleLoop(){
    if(tests[1].existApply(ddclickCenter)){
        sleep(getRandomInt(300,450))  
    }

    if(tests[2].existApply(no_action)){
        gesture(getRandomInt(800,1200),[130,1600],[getRandomInt(160,900),450])
        sleep(200)
        tests[2].existApply((x,y,w,h)=>{
            gesture(getRandomInt(800,1200),[130,1600],[getRandomInt(160,900),450])
            sleep(200)
        }) 
        tests[2].existApply((x,y,w,h)=>{
            gesture(getRandomInt(800,1200),[340,1600],[getRandomInt(160,900),450])
            sleep(200)
        }) 
        tests[2].existApply((x,y,w,h)=>{
            gesture(getRandomInt(800,1200),[780,1600],[getRandomInt(160,900),450])
            sleep(200)
        }) 
        tests[2].existApply((x,y,w,h)=>{
            gesture(getRandomInt(800,1200),[980,1600],[getRandomInt(160,900),450])
            sleep(200)
        })  
    }
    // tests[2].existApply((x,y,w,h)=>{
