...
var mode=1;
let proj="com_loancash_creditunion_trading_instant"
let projP="com.loancash.creditunion.trading.instant.autojs"
let projR="com.loancash.creditunion.trading.instant"
function getPath(p){
    switch(mode){
        case 5:
...
function guid(){
    ...
    zutils.afollow([
        ["t","English",0],   
        ["i","com.loancash.creditunion.trading.instant:id/imv_selected",1000,1000], 
    ])
...
function logic1() { 
    zutils.afollow([ 
        ["i","com.loancash.creditunion.trading.instant:id/tvStart",0],   
        ["i","com.loancash.creditunion.trading.instant:id/btn_back",1000,1000],  
    ])
...
function logic2() { 
    zutils.afollow([ 
        ["i","com.loancash.creditunion.trading.instant:id/ic_additional",0], 
        ["i","com.loancash.creditunion.trading.instant:id/ic_compare",0,1500], 
        ["i","com.loancash.creditunion.trading.instant:id/ic_setting",0,1500], 
        ["i","com.loancash.creditunion.trading.instant:id/ic_home",1000,1000],  
    ])
...
function logic3() { 
    zutils.afollow([ 
        ["i","com.loancash.creditunion.trading.instant:id/tvStartNow",0],   
        ["i","com.loancash.creditunion.trading.instant:id/btn_back",1000,1000],  
    ])
