...
var mode=1;
let proj="com_mbit_applock_lockapps_fingerprint_password"
let projP="com.mbit.applock.lockapps.fingerprint.password.autojs"
let projR="com.mbit.applock.lockapps.fingerprint.password"
function getPath(p){
    switch(mode){
        case 5:
...
function guid(){
    ...
    zutils.afollow([
        ["t","English (US)",0,0],
        ["i","com.mbit.applock.lockapps.fingerprint.password:id/btnDone",0,1000],
        right2Left,
        right2Left,
        right2Left,
        right2Left,
...
function main(){
    ...
    app.launch(projR)
   // app.startActivity({ 
   //     packageName: "com.mbit.applock.lockapps.fingerprint.password",
