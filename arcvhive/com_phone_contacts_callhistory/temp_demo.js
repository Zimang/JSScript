...
var mode=1;
let proj="com_phone_contacts_callhistory"
let projP="com.phone.contacts.callhistory.autojs"
let projR="com.phone.contacts.callhistory"
function getPath(p){
    switch(mode){
        case 5:
...
function guid(){
    ...
    zutils.afollow([
        ["t","English",0],  
        ["t","Select language",0,1500,nextTo],
        ["i","com.phone.contacts.callhistory:id/checkBox",0,1500],
        ["t","Continue",0,1500],  
        right2Left,
        right2Left,
        right2Left,
        ...
        right2Left,
        ["t","Start",0,1500],  
        ["t","Set As Default",1000,1500],  
    ])

    if(!zutils.afollow([
        ["t","Set As Default",1000,1500,no_action], 
    ])){
        zutils.afollow([   
            ["t","Contacts",0,1500], 
            ["t","SET AS DEFAULT",1000,1500],  
        ...
        zutils.afollow([ 
            ["t","Cancel",1000,1500],  
            ["i","com.phone.contacts.callhistory:id/btnSetAsDefault",0,1500],  
            ["t","ALLOW",0,1500],  
            ["t","ALLOW",0,1500],  
            ["t","ALLOW",0,1500],  
            ["t","ALLOW",0,1500],  
            ["t","Contacts",0,1500],  
            ["i","android:id/switch_widget",0,1500],  
            ["d","Navigate up",0,1500],  
            ["d","Navigate up",0,1500],  
            ["t","Skip",0,1500],  
        ])
    } 
...
function logic1() { 
    zutils.afollow([
        ["i","com.phone.contacts.callhistory:id/ivDialPad",0],  
        ["i","com.phone.contacts.callhistory:id/ivSettings",0,1500],
        ["i","com.phone.contacts.callhistory:id/ivContact",1000,1000], 
    ])
...
function logic2() { 
    zutils.afollow([
        ["i","com.phone.contacts.callhistory:id/tabHistory",0],  
        ["i","com.phone.contacts.callhistory:id/ivFavorite",0,1500],
        ["i","com.phone.contacts.callhistory:id/ivContact",1000,1000], 
    ])
...
function logic3() { 
      zutils.afollow([
        ["i","com.phone.contacts.callhistory:id/ivcreateContact",0],  
        ["d","Cancel",1000,1000], 
    ])  
}
...
function singleTest(){
    ...
    zutils.afollow([
        ...
        right2Left,
        ["t","Start",0,1500],  
        ["t","Set As Default",0,1500],  
        ["t","Contacts",0,1500],  
        ["t","SET AS DEFAULT",0,1500],  
        ["t","Skip",0,1500],  
        ["t","Continue",1000,1000],  
    ])
    // zutils.afollow([
    //     ["i","com.phone.contacts.callhistory:id/ivDialPad",0],  
    //     ["i","com.phone.contacts.callhistory:id/ivSettings",0,1500],
