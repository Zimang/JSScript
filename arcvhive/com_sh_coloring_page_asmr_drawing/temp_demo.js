...
var mode=1;
let proj="com_sh_coloring_page_asmr_drawing"
let projP="com.sh.coloring.page.asmr.drawing.autojs"
let projR="com.sh.coloring.page.asmr.drawing"
function getPath(p){
    switch(mode){
        case 5:
...
let hand=new zutils.CachedBT(
    "cut_1_1.png",getPath(""),"buttom 1"
) 

let title=new zutils.CachedBT(
...
function cbt(arr){
    arr.forEach(function(i){
        let bt=new zutils.CachedBT(
            i,getPath(""),i
        ) 
        bt.existApply(no_action)
    })
}
