...
var mode=1;
let proj="com_leftright_women_fashion_games"
let projP="com.leftright.women.fashion.games.autojs"
let projR="com.leftright.women.fashion.games"
function getPath(p){
    switch(mode){
        case 5:
...
function main(){
    ...
    app.launch(projR)
   // app.startActivity({ 
   //     packageName: "com.leftright.women.fashion.games",
