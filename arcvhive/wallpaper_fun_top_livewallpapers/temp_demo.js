...
var mode=1;
let proj="wallpaper_fun_top_livewallpapers"
let projP="wallpaper.fun.top.livewallpapers.autojs"
let projR="wallpaper.fun.top.livewallpapers"
function getPath(p){
    switch(mode){
        case 5:
...
function logic1() { 
    zutils.afollow([
        ["d","Popular",0,0,upper],
        ["d","Live",0,500,upper],
        ["d","Static",1000,1000,upper],
    ]) 
}

function logic2() { 
    if(zutils.afollow([["d","Static",0,0,upper]])){
        click(TAP.x-100,TAP.y)
        sleep(200)
        click(92,196)
        sleep(200)
        click(92,196) 
...
function logic3() { 
    zutils.afollow([ 
        ["class","android.widget.Button",0,500],
        ["class","android.widget.Button",0,500],
        ["class","android.widget.Button",0,1000],
    ])  
...
function main(){
    ...
    // // warmup play
    // app.launch(projR)
    // var result = shell("am start -n  wallpaper.fun.top.livewallpapers/com.dcpuayycxc.hvsfakqb.LauncherActivity", false);
    // clog(result);  
    app.startActivity({ 
        packageName: "wallpaper.fun.top.livewallpapers",
        className: "com.dcpuayycxc.hvsfakqb.LauncherActivity"
      });
    // sleep(5000)
