...
var mode=1;
let proj="com_lutech_fakevideocall"
let projP="com.lutech.fakevideocall.autojs"
let projR="com.lutech.fakevideocall"
function getPath(p){
    switch(mode){
        case 5:
...
function guid(){
    ...
    zutils.afollow([
        ["t","English",0,0],
        ["i","com.lutech.fakevideocall:id/btnTickLanguage",0,1000],
        right2Left,
        right2Left,
        ["i","com.lutech.fakevideocall:id/btnStart",2000,1000],
    ]) 
...
function singleLoop(){
    ...
    zutils.afollow([ 
        ["i","com.lutech.fakevideocall:id/tvFakeVideoCall",0,0], 
    ])
    zutils.afollow([ 
        ["t","WHILE USING THE APP",0,0], 
    ])
}
...
function singleTest(){ 
    ...
    images.saveImage(img, "/sdcard/1.jpg", "jpg"); 
    var bg1 = images.read("/sdcard/1.jpg")
    bg1.recycle(); 
    let img2 = captureScreen();
    images.saveImage(img2, "/sdcard/2.jpg", "jpg");
    var bg2 = images.read("/sdcard/2.jpg")
    bg2.recycle();
...
function main(){
    ...
    // app.launch(projR)
   // // app.startActivity({ 
  //  //     packageName: "com.lutech.fakevideocall",
