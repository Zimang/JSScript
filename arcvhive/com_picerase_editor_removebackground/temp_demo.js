...
var mode=1;
let proj="com_picerase_editor_removebackground"
let projP="com.picerase.editor.removebackground.autojs"
let projR="com.picerase.editor.removebackground"
function getPath(p){
    switch(mode){
        case 5:
...
let ok1=new zutils.CachedBT(
    "cut_1_2.png",getPath(""),"buttom 1"
) 
let ok2=new zutils.CachedBT(
    "cut_2_1.png",getPath(""),"buttom 1"
) 

let back1=new zutils.CachedBT(
    "cut_3_2.png",getPath(""),"buttom 1"
) 
...
function guid(){
    ...
    zutils.afollow([
        ["t","English",0],  
        ["d","Confirm",0,1500], //确认语言   
        ["d","Checkbox",0,1500], //选择功能
        ["t","Next",0,1500], //Next
        right2Left,
        right2Left,
        right2Left,
    ...
    zutils.afollow([
        ["t","Notification",0,0,agree],
        ["t","ALLOW",0,1000],
        ["t","Photo Library",0,1000,agree],
        ["t","ALLOW",0,1000],
        ()=>{click(TAP.x,TAP.y*0.2);sleep(500); return true}, 
    ])
    zutils.afollow([
        ["d","Close",0,0], 
    ])
