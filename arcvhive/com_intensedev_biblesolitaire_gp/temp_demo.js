...
var mode=1;
let proj="com_intensedev_biblesolitaire_gp"
let projP="com.intensedev.biblesolitaire.gp.autojs"
let projR="com.intensedev.biblesolitaire.gp"
function getPath(p){
    switch(mode){
        case 5:
...
function main(){
    ...
    app.launch(projR)
   // app.startActivity({ 
   //     packageName: "com.intensedev.biblesolitaire.gp",
