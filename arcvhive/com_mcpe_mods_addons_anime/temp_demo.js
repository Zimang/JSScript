...
var mode=1;
let proj="com_mcpe_mods_addons_anime"
let projP="com.mcpe.mods.addons.anime.autojs"
let projR="com.mcpe.mods.addons.anime"
function getPath(p){
    switch(mode){
        case 5:
...
function guid(){
    ...
    // ])
    zutils.afollow([
        ["i","com.mcpe.mods.addons.anime:id/next",0,0], 
    ])
    zutils.afollow([
        ["i","com.mcpe.mods.addons.anime:id/exit",0,0], 
    ])
    zutils.afollow([
        ["i","close-button",0,0], 
    ])
...
// 定义三个无副作用的逻辑函数
function logic1() { 
//com.mcpe.mods.addons.anime:id/thumbnail
    zutils.afollow([
        ["i","com.mcpe.mods.addons.anime:id/thumbnail",0,0], 
        ["i","com.mcpe.mods.addons.anime:id/popup_btn",0,500], 
    ])
    sleep(getRandomInt(1000,1500))
    if( 
    zutils.afollow([
        ["i","com.mcpe.mods.addons.anime:id/description",0,0],  
    ])){
        sleep(getRandomInt(1000,1500))
        back()
    }
...
function logic2() { 
    gesture(1000,[TAP.x,TAP.y-200],[TAP.x,TAP.y+200])
}
...
function main(){
    ...
    app.launch(projR)
   // app.startActivity({ 
   //     packageName: "com.mcpe.mods.addons.anime",
