...
var mode=1;
let proj="com_musicdym_player"
let projP="com.musicdym.player.autojs"
let projR="com.musicdym.player"
function getPath(p){
    switch(mode){
        case 5:
...
function guid(){
    ...
    zutils.afollow([
        ["i","com.musicdym.player:id/iv_one_hour",0],   
        ["t","Cancel",1000,1000],  
    ]) 
}
function shift(){ 
...
function logic3() { 
    ...
    zutils.afollow([
        ["i","com.musicdym.player:id/iv_set",0],   
        ["i","com.musicdym.player:id/iv_back",1000,1000],  
    ])
}
