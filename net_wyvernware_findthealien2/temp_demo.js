...
var mode=1;
let proj="net_wyvernware_findthealien2"
let projP="net.wyvernware.findthealien2.autojs"
let projR="net.wyvernware.findthealien2"
function getPath(p){
    switch(mode){
        case 5:
...
function main(){
    ...
    app.launch(projR)
   // app.startActivity({ 
   //     packageName: "net.wyvernware.findthealien2",
